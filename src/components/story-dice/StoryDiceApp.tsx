...
const StoryDiceApp: React.FC = () => {
  ...
  return <div className="min-h-screen bg-gradient-to-br from-shiny-blue-50 via-white to-shiny-blue-100 relative overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <div className="absolute top-[60%] right-[15%] w-40 h-40 bg-shiny-blue-300/15 rounded-full blur-3xl animate-float" style={{
        animationDelay: '2s'
      }}></div>
        <div className="absolute bottom-[30%] left-[20%] w-24 h-24 bg-shiny-blue-400/10 rounded-full blur-3xl animate-float" style={{
        animationDelay: '4s'
      }}></div>
        <div className="absolute top-[40%] right-[5%] w-28 h-28 bg-shiny-blue-500/10 rounded-full blur-3xl animate-float" style={{
        animationDelay: '6s'
      }}></div>
      </div>
      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8 relative z-10">
        ...
        <div className="text-center mb-16 animate-fade-in">
          <div className="relative inline-block mb-8">
            ...
            <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold bg-gradient-to-r from-shiny-blue-600 via-shiny-blue-700 to-shiny-blue-800 bg-clip-text mb-6 leading-tight text-gray-950">
              ZANS Story Dice
            </h1>
            <Wand2 className="absolute -bottom-4 -right-4 w-8 h-8 text-shiny-blue-500 animate-pulse" style={{
            animationDelay: '1s'
          }} />
          </div>
        ...
        {/* Main Content */}
        {!storyData ? <div className="space-y-12 animate-fade-in" style={{
        animationDelay: '0.3s'
      }}>
          ...
          </div> : <div className="animate-fade-in backdrop-blur-sm bg-white/70 rounded-3xl p-8 shadow-2xl border border-white/50">
            <StoryDisplay storyData={storyData} onReset={handleReset} capturedImage={capturedImage || ''} />
          </div>}
      </div>
    </div>;
};
