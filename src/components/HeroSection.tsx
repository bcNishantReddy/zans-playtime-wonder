...
const HeroSection: React.FC = () => {
  ...
  return (
    <section className="relative overflow-hidden py-6 md:py-12 bg-white">
      {/* Enhanced background */}
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        <div className="absolute top-4 left-4 text-xl sm:text-3xl animate-float" style={{ animationDelay: '0s' }}>📚</div>
        <div className="absolute top-8 right-8 text-lg sm:text-2xl animate-float" style={{ animationDelay: '0.5s' }}>✨</div>
        <div className="absolute top-16 left-16 text-2xl sm:text-4xl animate-float" style={{ animationDelay: '1s' }}>🎲</div>
        <div className="absolute top-12 right-24 text-lg sm:text-2xl animate-float" style={{ animationDelay: '1.5s' }}>🌟</div>
        
        <div className="absolute top-1/3 left-8 text-xl sm:text-3xl animate-float" style={{ animationDelay: '2s' }}>🎭</div>
        <div className="absolute top-1/3 right-8 text-lg sm:text-2xl animate-float" style={{ animationDelay: '2.5s' }}>🏰</div>
        <div className="absolute top-1/2 left-4 text-2xl sm:text-4xl animate-float" style={{ animationDelay: '3s' }}>🦁</div>
        <div className="absolute top-1/2 right-4 text-xl sm:text-3xl animate-float" style={{ animationDelay: '3.5s' }}>🚂</div>
        
        <div className="absolute bottom-24 left-12 text-lg sm:text-2xl animate-float" style={{ animationDelay: '4s' }}>🌈</div>
        <div className="absolute bottom-20 right-12 text-xl sm:text-3xl animate-float" style={{ animationDelay: '4.5s' }}>🎨</div>
        <div className="absolute bottom-16 left-20 text-lg sm:text-2xl animate-float" style={{ animationDelay: '5s' }}>🦄</div>
        <div className="absolute bottom-32 right-20 text-xl sm:text-3xl animate-float" style={{ animationDelay: '5.5s' }}>🎪</div>
      </div>
        ...
        <div className="flex flex-col items-center justify-center">
          ...
          <div className="text-center w-full max-w-3xl mx-auto bg-white/80 backdrop-blur-sm rounded-xl md:rounded-2xl p-4 md:p-8 shadow-lg">
            ...
            <div className="flex flex-wrap justify-center gap-2 md:gap-4 mb-6 md:mb-8">
              ...
              <span className="bg-gradient-to-r from-green-100 to-emerald-100 px-2 py-1 md:px-4 md:py-2 rounded-full text-green-700 font-medium text-xs sm:text-sm">
                📱 Screen Free
              </span>
